...
echo "* Disabling Apache PHP 8.4 module..."
sudo a2dismod php8.4 > /dev/null

echo "* Enabling Apache PHP 8.5 module..."
sudo a2enmod php8.5 > /dev/null

echo "* Restarting Apache..."
sudo service apache2 restart > /dev/null

echo "* Switching CLI PHP to 8.5..."
sudo update-alternatives --set php /usr/bin/php8.5 > /dev/null
